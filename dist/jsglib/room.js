...
(function (window) {
	...
	var Room = (function (_JSGlib$EventsHandler) {
		_inherits(Room, _JSGlib$EventsHandler);
			...
			value: function useDefinition(data) {
				...
				var promise = function promise(resolve) {
					if (typeof data === 'string') {
						JSGlib.http.get(data, { data_type: JSGlib.http.DATA_TYPES.JSON }).then(function (data) {
